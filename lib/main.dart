...
class _HomePageState extends State<HomePage> {
  ...
  List<dynamic> _services = [
    ...
    ['Yuxarı', Iconsax.import, Colors.pink],
    ['Pul', Iconsax.wallet_3, Colors.orange],
    ['Daha çox', Iconsax.more, Colors.green],
  ];

  List<dynamic> _transactions = [
    ['Amazon', 'https://img.icons8.com/color/2x/amazon.png', '21:00', '\$8.90'],
    [
      'ATM-dən nağd pul',
